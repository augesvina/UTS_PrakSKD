...
def main():
    ...
    pesanDekripsi= "RONHMRMTXVNNQNVZFQFQKOCJQRHZYNZNLQQSCDYPDWZZZZAPYWBIYYQMOPYPZNNTCMND"
    kunci = 'augesvina'
    mode1 = 'enkripsi'
    mode2 = 'dekripsi' 
...
def main():
    ...
    text = 'RONHMRMTXVNNQNVZFQFQKOCJQRHZYNZNLQQSCDYPDWZZZZAPYWBIYYQMOPYPZNNTCMND'#Pesan yang akan di enkripsi
    key = [7, 2]
    ...
    print('Ciphertext : RWPZIRIFHTPPKPTVLKLKUWQNKRZVOPVPBKKYQXODXAVVVVCDOAJGOOKIWDODVPPFQIPX')
